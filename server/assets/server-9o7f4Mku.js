...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DxqmMFbo.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BiYSDjN3.js").then((n) => n.r),
    import("./start-BFelXtwT.js"),
...
var ROUTER_BASEPATH = "smederevoapartmani";
var SERVER_FN_BASE = "/smederevoapartmani/_serverFn/";
